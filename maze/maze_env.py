# THIS CODE WAS COPIED FROM THE ORIGINAL AUTHOR'S GUTHUB WITH VERY FEW ALTERATIONS
# one alteration was to change the import syntax from version 3.9 (what the authors ran) to 3.6 (what I'm running)

...
# OPIQ
# baseline
# agent = OPIQ_Agent(MazeNetwork, (10*env.size, 10*env.size, 1), 4)
# the weird one
# agent = OPIQ_Agent(MazeNetwork, (10*env.size, 10*env.size, 1), 4, hash_size=128, batch_size=64, num_steps=3, train_on_gpu=True)
